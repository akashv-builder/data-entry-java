...
public class itemissue extends JFrame implements ActionListener
{
...
{       getDetails();
        ...
        l1=new JLabel("ITEM ISSUE SCREEN");
	...
	l5=new JLabel("QOH:");
        ...
        l5.setFont(p);
        l6=new JLabel("DOI(DD-MM-YY):");
        l6.setBounds(501,500,300,50);
        l6.setFont(p);
        l7=new JLabel("QUANTITY ISSUED:");
      ...
      try
{
      ...
      String query="insert into tblissue(icode,iname,rate,doi,qi) values ("+icodes.getSelectedItem().toString()+",'"+t2.getText()+"',"+t3.getText()+",'"+t5.getText()+"',"+t6.getText()+")";
 ...
 try
{
      ...
      Connection con=DriverManager.getConnection("jdbc:odbc:inventorydsn");
      Statement stmt=con.createStatement(); 
      String query="update tblstock set qoh=qoh-"+t6.getText()+" where icode="+icodes.getSelectedItem().toString();
      stmt.executeUpdate(query);
